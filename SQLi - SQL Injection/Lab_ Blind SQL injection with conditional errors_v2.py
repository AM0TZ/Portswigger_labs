...
def print_status(response, password):
...
def check_password():
    ...
    while not done:
        for i in char_list:
            ...
            response = requests.get(burp0_url, headers=burp0_headers, cookies=loaded_cookies, proxies={"http": "http://127.0.0.1:8080"})
            print_status(response, password)
