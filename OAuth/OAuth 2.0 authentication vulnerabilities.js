...
1st - authentivcation initialization
2nd - redirecting using blog's next path feature + path traversl
3rd - link to the exploit location

A. this leaks the token via fragment in the URI
B. when victims returns back to the malicious link (window.location.hash = True)
